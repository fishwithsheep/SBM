...
class two_dimension_Coulomb_SBM_solution():
    ...
    def solve(self,dt,V):
        ...
        for t in range(int(self.T / dt)):
            ...
            if t % int(1 / dt) == int(1 / dt) - 1:
                np.save(f'T={(t + 1) * dt}_dt={dt}_n={self.n}_N={length}_epsilon={self.epsilon}_2d-Coulomb_SBM_velocity', V)
...
def plot(T,V,n,v,dt):
    ...
    plt.ylabel('f')
    plt.legend()
    plt.savefig(f'T={T}_dt={dt}_n={n}_N={N}_epsilon={epsilon}_2d-Coulomb_SBM_cross-section.png',dpi=160)
    plt.close()
    # plt.show()
    ...
    ay.set_title('SBM')
    plt.savefig(f'T={T}_dt={dt}_n={n}_N={N}_epsilon={epsilon}_2d-Coulomb_SBM_3d-graph.png',dpi=160)
    plt.close()
    # plt.show()
...
def save_and_draw(T,v,n,point,N,epsilon,dt):
    ...
    Y = two_dimension_Coulomb_SBM_solution(T=T, L=v, n=n, Lambda=Lambda, gamma=gamma,epsilon=epsilon)
    V, mass, momentum, energy1, energy2, relative_L2_error, entropy, relative_entropy, Time = Y.solve(dt=dt,V=point)

    np.save(f'T={T}_dt={dt}_n={n}_N={N}_epsilon={epsilon}_2d-Coulomb_SBM_grid-mass', mass)
    np.save(f'T={T}_dt={dt}_n={n}_N={N}_epsilon={epsilon}_2d-Coulomb_SBM_grid-momentum', momentum)
    np.save(f'T={T}_dt={dt}_n={n}_N={N}_epsilon={epsilon}_2d-Coulomb_SBM_grid-energy', energy1)
    np.save(f'T={T}_dt={dt}_n={n}_N={N}_epsilon={epsilon}_2d-Coulomb_SBM_particle-energy', energy2)
    np.save(f'T={T}_dt={dt}_n={n}_N={N}_epsilon={epsilon}_2d-Coulomb_SBM_relative-L2-error', relative_L2_error)
    np.save(f'T={T}_dt={dt}_n={n}_N={N}_epsilon={epsilon}_2d-Coulomb_SBM_entropy', entropy)
    np.save(f'T={T}_dt={dt}_n={n}_N={N}_epsilon={epsilon}_2d-Coulomb_SBM_relative-entropy(SBM_vs_reference)',relative_entropy)
    np.save(f'T={T}_dt={dt}_n={n}_N={N}_epsilon={epsilon}_2d-Coulomb_SBM_total-time', Time)
    ...
    plt.savefig(f'T={T}_dt={dt}_n={n}_N={N}_epsilon={epsilon}_2d-Coulomb_SBM_grid-mass.png', dpi=160)
    plt.close()
    # plt.show()
    ...
    plt.ylabel('momentum')
    plt.title('momentum')
    plt.savefig(f'T={T}_dt={dt}_n={n}_N={N}_epsilon={epsilon}_2dCoulomb_SBM_grid-momentum.png', dpi=160)
    plt.close()
    # plt.show()
    plt.plot(t, energy1)
    plt.xlabel("T")
    ...
    plt.savefig(f'T={T}_dt={dt}_n={n}_N={N}_epsilon={epsilon}_2d-Coulomb_SBM_grid-energy.png', dpi=160)
    plt.close()
    # plt.show()
    plt.plot(t, energy2)
    plt.xlabel("T")
    ...
    plt.savefig(f'T={T}_dt={dt}_n={n}_N={N}_epsilon={epsilon}_2d-Coulomb_SBM_particle-energy.png', dpi=160)
    plt.close()
    # plt.show()
    ...
    plt.savefig(f'T={T}_dt={dt}_n={n}_N={N}_epsilon={epsilon}_2d-Coulomb_SBM_relative-L2-error.png', dpi=160)
    plt.close()
    # plt.show()
    plt.plot(t, entropy)
    plt.xlabel("T")
    plt.ylabel('entropy')
    plt.title('entropy')
    plt.savefig(f'T={T}_dt={dt}_n={n}_N={N}_epsilon={epsilon}_2d-Coulomb_SBM_entropy.png', dpi=160)
    plt.close()
    # plt.show()
    ...
    plt.savefig(f'T={T}_dt={dt}_n={n}_N={N}_epsilon={epsilon}_2d-Coulomb_SBM_relative-entropy(SBM_vs_reference).png',
                dpi=160)
    plt.close()
    # plt.show()
