...
class three_dimension_Coulomb_SBM_solution():
    def __init__(self,T,L,n,Lambda,gamma,epsilon,sigma=0.7):
        ...
        grid_ = np.mgrid[-self.L + self.h / 2: self.L + self.h / 2: self.h,
            -self.L + self.h / 2: self.L + self.h / 2: self.h,
            -self.L + self.h / 2: self.L + self.h / 2: self.h]
        self.vx_ = grid_[0].reshape([-1, 1])
        self.vy_ = grid_[1].reshape([-1, 1])
        self.vz_ = grid_[2].reshape([-1, 1])
        ...
        grid__ = np.mgrid[-self.L + self.h0 / 2: self.L + self.h0 / 2: self.h0,
            -self.L + self.h0 / 2: self.L + self.h0 / 2: self.h0,
            -self.L + self.h0 / 2: self.L + self.h0 / 2: self.h0]
        self.vx__ = grid__[0].reshape([-1, 1])
        self.vy__ = grid__[1].reshape([-1, 1])
        self.vz__ = grid__[2].reshape([-1, 1])
    ...
    def solve(self,dt,V):
        ...
        for t in range(int(self.T / dt)):
            ...
            if t % int(1 / dt) == int(1 / dt) - 1:
                np.save(f'T={(t + 1) * dt}_dt={dt}_n={self.n}_N={length}_epsilon={self.epsilon}_3d-Coulomb_SBM_velocity', V)
...
def save_and_draw(T,v,n,point,N,epsilon,dt):
    ...
    np.save(f'T={T}_dt={dt}_n={n}_N={N}_epsilon={epsilon}_3d-Coulomb_SBM_grid-mass', mass)
    np.save(f'T={T}_dt={dt}_n={n}_N={N}_epsilon={epsilon}_3d-Coulomb_SBM_grid-momentum', momentum)
    np.save(f'T={T}_dt={dt}_n={n}_N={N}_epsilon={epsilon}_3d-Coulomb_SBM_grid-energy', energy1)
    np.save(f'T={T}_dt={dt}_n={n}_N={N}_epsilon={epsilon}_3d-Coulomb_SBM_particle-energy', energy2)
    np.save(f'T={T}_dt={dt}_n={n}_N={N}_epsilon={epsilon}_3d-Coulomb_SBM_relative-L2-error', relative_L2_error)
    np.save(f'T={T}_dt={dt}_n={n}_N={N}_epsilon={epsilon}_3d-Coulomb_SBM_entropy', entropy)
    np.save(f'T={T}_dt={dt}_n={n}_N={N}_epsilon={epsilon}_3d-Coulomb_SBM_relative-entropy(SBM_vs_reference)',relative_entropy)
    np.save(f'T={T}_dt={dt}_n={n}_N={N}_epsilon={epsilon}_3d-Coulomb_SBM_total-time', Time)
    ...
    plt.savefig(f'T={T}_dt={dt}_n={n}_N={N}_epsilon={epsilon}_3d-Coulomb_SBM_grid-mass.png', dpi=160)
    plt.close()
    # plt.show()
    ...
    plt.ylabel('momentum')
    plt.title('momentum')
    plt.savefig(f'T={T}_dt={dt}_n={n}_N={N}_epsilon={epsilon}_3dCoulomb_SBM_grid-momentum.png', dpi=160)
    plt.close()
    # plt.show()
    plt.plot(t, energy1)
    plt.xlabel("T")
    ...
    plt.savefig(f'T={T}_dt={dt}_n={n}_N={N}_epsilon={epsilon}_3d-Coulomb_SBM_grid-energy.png', dpi=160)
    plt.close()
    # plt.show()
    plt.plot(t, energy2)
    plt.xlabel("T")
    ...
    plt.savefig(f'T={T}_dt={dt}_n={n}_N={N}_epsilon={epsilon}_3d-Coulomb_SBM_particle-energy.png', dpi=160)
    plt.close()
    # plt.show()
    ...
    plt.savefig(f'T={T}_dt={dt}_n={n}_N={N}_epsilon={epsilon}_3d-Coulomb_SBM_relative-L2-error.png', dpi=160)
    plt.close()
    # plt.show()
    plt.plot(t, entropy)
    plt.xlabel("T")
    plt.ylabel('entropy')
    plt.title('entropy')
    plt.savefig(f'T={T}_dt={dt}_n={n}_N={N}_epsilon={epsilon}_3d-Coulomb_SBM_entropy.png', dpi=160)
    plt.close()
    # plt.show()
    ...
    plt.savefig(f'T={T}_dt={dt}_n={n}_N={N}_epsilon={epsilon}_3d-Coulomb_SBM_relative-entropy(SBM_vs_reference).png',
                dpi=160)
    plt.close()
    # plt.show()
